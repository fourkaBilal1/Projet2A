...
class OnlineTrainer:
    def __init__(self, robot, NN):
        ...
        self.gain = [1, 1, 0.5] #Strategy gain for criterion calculation
    ...
    def train(self, target):
        ...
        J_ref = self.gain[0]*x_m**2 + self.gain[1]*y_m**2 + self.gain[2]*theta_m**2
        ...
        while self.running:
            ...
            J = self.gain[0]*x_m**2 + self.gain[1]*y_m**2 + self.gain[2]*theta_m**2
