...
#choice = raw_input('Do you want to load previous network? (y/n) --> ')
...
while choice!='y' and choice !='n':
    #choice = raw_input('Do you want to learn? (y/n) --> ')
...
#target = raw_input("Enter the first target : x y radian --> ")
...
while(continue_running):
    ...
    #raw_input("Press Enter to stop the current training")
    input("Press Enter to stop the current training")
    trainer.running = False
    
    #Ask for log file name
    #name = raw_input("Give a name to the log file (default to last) --> ")
    ...
    if choice == 'y':
        ...
        while choice_learning != 'y' and choice_learning !='n':
            #choice_learning = raw_input('Do you want to learn ? (y/n) --> ')
            choice_learning = input('Do you want to learn ? (y/n) --> ')
        if choice_learning =='y':
            trainer.training = True
        elif choice_learning == 'n':
            trainer.training = False
        #target = raw_input("Move the robot to the initial point and enter the new target : x y radian --> ")
